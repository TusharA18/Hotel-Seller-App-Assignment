...
import { selectData } from "../redux/property/propertySlice";
import { useSelector } from "react-redux";

const PropertyIdCard = () => {
   const data = useSelector(selectData);

   return (
      <div className="min-h-screen flex justify-center items-center">
         <div className="w-[20rem] h-[27.4rem] bg-white p-2 rounded-xl">
            ...
            <div className="px-3">
               <div className="pt-3 space-y-2">
                  ...
                  <h1 className="text-lg h-12 font-semibold">
                     {data?.address}
                  </h1>
               </div>
               ...
               <div className="flex justify-between items-center pt-3">
                  <h1 className="font-bold">
                     <span className="text-[#373ae3] text-lg">
                        ${data?.price}
                     </span>{" "}
                     / month
                  </h1>
